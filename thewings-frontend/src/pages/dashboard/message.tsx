    ...
    return (
        <Stack flex={1} bgcolor="#15161661" justifyContent="center" alignItems="center">
            ...
            <div className="h-full bg-[#333b5638] col-span-1 w-full p-3">
                <h1 className="p-3 text-center text-2xl font-serif font-bold text-white ">Message</h1>
                <Search className="px-3 py-2 h-auto text-white min-w-[100%] border-white outline-none rounded-sm"/>
            </div>
                ...
                <form>
                    ...
                    <footer className="absolute bottom-0 w-full p-3 box-border">
                        <div className="w-full h-[40px] flex items-center justify-center">
                            <input type="text" className="w-[95%] text-black pl-3 rounded-3xl h-full" placeholder="Type a message..."/>
