import datetime
from rest_framework.serializers import ModelSerializer, ImageField, SerializerMethodField, CharField, ValidationError
...
class UserCreateProfileSerializer(ModelSerializer):
    avatar = ImageField(max_length=None, use_url=True, required=False, allow_empty_file=True)
    cover_image = ImageField(max_length=None, use_url=True, required=False, allow_empty_file=True)
    class Meta:
        model = Profile
